...
<body>
	...
	<h3>sessionBean3.data5 : ${sessionScope.sessionBean3.data5 }</h3>
	<h3>sessionBean3.data6 : ${sessionScope.sessionBean3.data6 }</h3>
	
	<h3>sessionBean4.data7 : ${sessionScope.sessionBean4.data7 }</h3>
	<h3>sessionBean5.data8 : ${sessionScope.sessionBean4.data8 }</h3>
</body>
</html>